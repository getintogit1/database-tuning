...
def generate_employees(filename="employees.csv"):
    ...
    with open(filename, "w", newline="") as file:
        ...
        for _ in range(TOTAL_EMPLOYEES):
            ...
            manager = random.choice(employees) if random.random() < 0.1 and employees else None                         # 10% have a manager
            ...
            employees.append(type("Emp", (), {"ssnum": ssnum}))                                                         # Store ssnum reference
            ssnum_counter += 1
